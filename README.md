...
1 Program otwiera plik dane.txt.

2 Wczytuje nazwę klasy oraz wychowawcę.

3 Wczytuje uczniów znajdujących się w pliku.

4 Wyszukuje największy istniejący numer ucznia.

5 Prosi użytkownika o podanie danych nowego ucznia.

6 Automatycznie nadaje mu kolejny numer.

7 Wyświetla informacje o klasie wraz z aktualną listą uczniów.
